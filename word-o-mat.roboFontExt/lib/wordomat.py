...
class WordomatWindow:
    ...
    def loadDictionaries(self):
        ...
        self.textfiles = ['arabic', 'catalan', 'czech', 'danish', 'dutch', 'ukacd', 'finnish', 'french', 'german', 'hungarian', 'icelandic', 'italian', 'latin', 'norwegian', 'polish', 'slovak', 'spanish', 'vietnamese']
